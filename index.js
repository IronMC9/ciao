...
client.on("messageCreate", (message) => {
    if(message.content == "!larry"){
        message.channel.send("Ciao sono LarryOP Bot. Digita **l!list** per avere la lista dei comandi")
    }
if(message.content == "!Larry"){
        message.channel.send("Ciao sono LarryOP Bot. Digita **l!list** per avere la lista dei comandi")
}
...
client.on("messageCreate", (message) => {
    if(message.content == "l!serverinfo"){
        ...
        if(message.content == "L!server info"){
            var embed = new Discord.MessageEmbed()
            .setDescription("**■▬▬▬▬▬▬◢◤◆◥◣▬▬▬▬▬▬■\n                       ・Saky MC・\n■▬▬▬▬▬▬◥◣◆◢◤▬▬▬▬▬▬■\n             \n╠《🔒》Stanze Private\n╠《🎶》Musica con Molti Bot, Anime\n╠《👮‍♂️》Self-Role\n╠《🎫》Ticket per Assistenza\n╠《◽》Sistema di Ranking\n╠《👨🏿‍🤝‍👨🏾》Partnership e Collaborazioni\n╠《🤝》Staff Accogliente, Disponibile e Attivo\n\n■▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬■\nBuona Permanenza E...\n    Divertiti! \n■▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬■**")
            .setColor("DARK_PURPLE")
            .setThumbnail("https://media.discordapp.net/attachments/935963945502646363/937700386599469096/20220131_142526_0000.png")
    ...
    if(message.content == "l!requisiti"){
        var embed = new Discord.MessageEmbed()
...
client.on("messageCreate", message => {
    if (message.content.startsWith("l!avatar")) {
        if (message.content.trim() == "l!avatar") {
...
client.user.setActivity('!larry', { type: "WATCHING" }); //Oppure LISTENING, PLAYING
});
...
client.on("messageCreate", message => {
if (message.content.startsWith("L!user info")) {
    if (message.content == "L!user info") {
        var utente = message.member;
    }
    else {
        var utente = message.mentions.members.first();
